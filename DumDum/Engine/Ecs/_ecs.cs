...
public partial class Archetype : SystemBase //initialization
{
	internal int _hashId;

	public Page _page;

	public int ArchtypeId { get => _page._pageId; }
...
public partial class Archetype //query archetypes
{

	internal static int ComputeArchetypeHash(List<Type> componentTypes)
	{
		throw new NotImplementedException();
	}
	internal bool DoesArchetypeMatch(int archHashId, ReadOnlySpan<Type> componentTypes)
	{
		throw new NotImplementedException();
	}
